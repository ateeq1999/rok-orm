//! [`MyModel`] — ergonomic async CRUD methods for any [`Model`] + MySQL.
//!
...
pub trait MyModel: Model + for<'r> sqlx::FromRow<'r, MyRow> + Send + Unpin {
    ...
    where
        Self: Sized,
    {
        mysql_executor::fetch_all(pool, Self::query()).await
    }
    ...
    where
        Self: Sized,
    {
        mysql_executor::fetch_all(pool, builder).await
    }
    ...
    where
        Self: Sized,
    {
        mysql_executor::count(pool, Self::query()).await
    }
    ...
    where
        Self: Sized,
    {
        mysql_executor::count(pool, builder).await
    }
    ...
    where
        Self: Sized,
    {
        mysql_executor::insert::<Self>(pool, Self::table_name(), data)
    }
        ...
        Self: Sized,
    {
        ...
        mysql_executor::update::<Self>(pool, builder, &data_with_timestamps).await
    }
    ...
    where
        Self: Sized,
    {
        mysql_executor::delete(pool, Self::find(id))
    }
    ...
    where
        Self: Sized,
    {
        mysql_executor::delete(pool, builder)
    }
    ...
    where
        Self: Sized,
    {
        mysql_executor::update::<Self>(pool, builder, data)
    }
    ...
    where
        Self: Sized,
    {
        mysql_executor::bulk_insert::<Self>(pool, Self::table_name(), rows)
    }
        ...
        Self: Sized,
    {
        ...
        mysql_executor::insert_returning::<Self>(pool, Self::table_name(), &data_with_timestamps).await
    }
    ...
    where
        Self: Sized,
    {
        mysql_executor::restore::<Self>(pool, Self::find(id))
    }
    ...
    where
        Self: Sized,
    {
        mysql_executor::restore::<Self>(pool, builder)
    }
    ...
    where
        Self: Sized,
    {
        mysql_executor::force_delete(pool, Self::find(id))
    }
    ...
    where
        Self: Sized,
    {
        mysql_executor::force_delete(pool, builder)
    }
    ...
    where
        Self: Sized,
    {
        let total = mysql_executor::count(pool, Self::query()).await?;
        let data = mysql_executor::fetch_all(pool, Self::query().paginate(page, per_page)).await?;
    ...
    where
        Self: Sized,
    {
        let total = mysql_executor::count(pool, builder.clone()).await?;
        let data = mysql_executor::fetch_all(pool, builder.paginate(page, per_page)).await?;
        Ok(crate::pagination::Page::new(data, total, per_page, page))
    }
    ...
    where
        Self: Sized,
    {
        mysql_executor::aggregate::<Self>(pool, Self::query(), "SUM", column).await
    }
    ...
    where
        Self: Sized,
    {
        mysql_executor::aggregate::<Self>(pool, Self::query(), "AVG", column).await
    }
    ...
    where
        Self: Sized,
    {
        mysql_executor::aggregate::<Self>(pool, Self::query(), "MIN", column).await
    }
    ...
    where
        Self: Sized,
    {
        mysql_executor::aggregate::<Self>(pool, Self::query(), "MAX", column).await
    }
    ...
    where
        Self: Sized,
    {
        mysql_executor::upsert::<Self>(pool, Self::table_name(), data, conflict_column, update_columns).await
    }
    ...
    where
        Self: Sized,
    {
        mysql_executor::upsert_returning::<Self>(pool, Self::table_name(), data, conflict_column, update_columns).await
    }
    ...
    where
        Self: Sized,
    {
        mysql_executor::delete_in::<Self>(pool, Self::table_name(), column, values).await
    }
    ...
    where
        Self: Sized,
    {
        mysql_executor::exists(pool, Self::query()).await
    }
    ...
    where
        Self: Sized,
    {
        mysql_executor::exists(pool, builder).await
    }
    ...
    where
        Self: Sized,
    {
        mysql_executor::pluck(pool, Self::query(), column).await
    }
    ...
    where
        Self: Sized,
    {
        mysql_executor::pluck(pool, builder, column).await
    }
    ...
    where
        Self: Sized,
    {
        mysql_executor::update_all(pool, Self::query(), data).await
    }
    ...
    where
        Self: Sized,
    {
        mysql_executor::update_all(pool, builder, data).await
    }
        ...
        Self: Sized,
    {
        ...
        mysql_executor::execute(pool, &sql, params).await
    }
}
