...
pub mod lazy {
    ...
    {
        let builder = relation.query_for(crate::query::SqlValue::Null);
        ...
        postgres::fetch_all(pool, combined_builder).await
    }
        ...
        C: Model + for<'r> sqlx::FromRow<'r, sqlx::postgres::PgRow> + Send + Unpin,
    {
        ...
        crate::executor::postgres::fetch_optional(pool, builder).await
    }
}
